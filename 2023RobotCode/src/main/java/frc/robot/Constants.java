...
public final class Constants {
  ...
  public static class ArmConstants {
    ...
    public static final double middlePosition = .6722;//was .6722
    public static final double highPosition = 1.12; // 1.0247 / was 184.6*old encoderTicksToMeters; 1.075
    public static final double pickupPosition = .334; //was .2997
    public static final double maxExtention = 1.12; // 1.0305 / was 199.6*old encoderTicksToMeters
  ...
  public static class CompNeoTurnToAngleConstants {
    public static final double kp = .0058;//was .0074
    ...
    public static final double base = .13;//was .1
    public static final double maxEndVelocity = .1; //in degrees per 20ms, .1 converts to 5 deg/s
    public static final double maxAccel = .3; //per 20 ms, from 0-1. .2 means you can go 0-full in .1s
  }
